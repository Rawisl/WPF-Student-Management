...
-- Grade 10 (DOB: 2010)
(15, N'Nguyễn Văn An', N'Nam', '2010-01-10', '0912345101', 'nguyenvanan100110@gmail.mock', N'Quận 1, TP.HCM', N'Gia đình cơ bản', N'Nguyễn Văn Ánh', '0987654101', 'Active'),
(16, N'Trần Thị Bình', N'Nữ', '2010-02-15', '0912345102', 'tranthibinh150210@gmail.mock', N'Quận 3, TP.HCM', N'Gia đình khá giả', N'Trần Văn Biên', '0987654102', 'Active'),
(17, N'Lê Hoàng Cường', N'Nam', '2010-03-20', '0912345103', 'lehoangcuong200310@gmail.mock', N'Quận 4, TP.HCM', N'Hộ nghèo', N'Lê Thị Cúc', '0987654103', 'Active'),
(18, N'Phạm Đức Duy', N'Nam', '2010-04-25', '0912345104', 'phamducduy250410@gmail.mock', N'Quận 5, TP.HCM', N'Gia đình cơ bản', N'Phạm Văn Dũng', '0987654104', 'Active'),
(19, N'Võ Thị Yến', N'Nữ', '2010-05-30', '0912345105', 'vothiyen300510@gmail.mock', N'Quận 7, TP.HCM', N'Gia đình cơ bản', N'Võ Văn Yên', '0987654105', 'Active'),
(20, N'Đặng Hải Đăng', N'Nam', '2010-06-05', '0912345106', 'danghaidang050610@gmail.mock', N'Quận 8, TP.HCM', N'Gia đình khá giả', N'Đặng Thị Đào', '0987654106', 'Active'),
(21, N'Bùi Ngọc Giàu', N'Nữ', '2010-07-10', '0912345107', 'buingocgiau100710@gmail.mock', N'Quận 10, TP.HCM', N'Gia đình cơ bản', N'Bùi Văn Gấm', '0987654107', 'Active'),
(22, N'Đỗ Minh Hiếu', N'Nam', '2010-08-15', '0912345108', 'dominhhieu150810@gmail.mock', N'Quận 11, TP.HCM', N'Gia đình cơ bản', N'Đỗ Thị Hiền', '0987654108', 'Active'),
(23, N'Hồ Nhật Khang', N'Nam', '2010-09-20', '0912345109', 'honhatkhang200910@gmail.mock', N'Tân Bình, TP.HCM', N'Gia đình cơ bản', N'Hồ Văn Khánh', '0987654109', 'Active'),
(24, N'Lý Gia Linh', N'Nữ', '2010-10-25', '0912345110', 'lygialinh251010@gmail.mock', N'Gò Vấp, TP.HCM', N'Hộ nghèo', N'Lý Thị Lan', '0987654110', 'Active'),
(25, N'Mai Phương Mai', N'Nữ', '2010-11-01', '0912345111', 'maiphuongmai011110@gmail.mock', N'Tân Phú, TP.HCM', N'Gia đình khá giả', N'Mai Văn Mẫn', '0987654111', 'Active'),
(26, N'Ngô Tiến Nam', N'Nam', '2010-12-05', '0912345112', 'ngotiennam051210@gmail.mock', N'Phú Nhuận, TP.HCM', N'Gia đình cơ bản', N'Ngô Thị Nga', '0987654112', 'Active'),
(27, N'Phan Bảo Ngọc', N'Nữ', '2010-01-12', '0912345113', 'phanbaongoc120110@gmail.mock', N'Bình Thạnh, TP.HCM', N'Gia đình cơ bản', N'Phan Văn Nghĩa', '0987654113', 'Active'),
(28, N'Hoàng Minh Quân', N'Nam', '2010-02-18', '0912345114', 'hoangminhquan180210@gmail.mock', N'Bình Tân, TP.HCM', N'Gia đình khá giả', N'Hoàng Thị Quyên', '0987654114', 'Active'),
(29, N'Vũ Quốc Sơn', N'Nam', '2010-03-22', '0912345115', 'vuquocson220310@gmail.mock', N'Thủ Đức, TP.HCM', N'Gia đình cơ bản', N'Vũ Văn Sáng', '0987654115', 'Active'),
(30, N'Trịnh Anh Tú', N'Nam', '2010-04-28', '0912345116', 'trinhanhtu280410@gmail.mock', N'Nhà Bè, TP.HCM', N'Hộ nghèo', N'Trịnh Thị Thủy', '0987654116', 'Active'),
(31, N'Đào Thanh Uyển', N'Nữ', '2010-05-02', '0912345117', 'daothanhuyen020510@gmail.mock', N'Hóc Môn, TP.HCM', N'Gia đình cơ bản', N'Đào Văn Uy', '0987654117', 'Active'),
(32, N'Nguyễn Hải Hà', N'Nữ', '2010-06-08', '0912345118', 'nguyenhaiha080610@gmail.mock', N'Bình Chánh, TP.HCM', N'Gia đình khá giả', N'Nguyễn Văn Hùng', '0987654118', 'Active'),
(33, N'Trần Văn Lộc', N'Nam', '2010-07-14', '0912345119', 'tranvanloc140710@gmail.mock', N'Quận 1, TP.HCM', N'Gia đình cơ bản', N'Trần Thị Liên', '0987654119', 'Active'),
(34, N'Lê Thị Thu', N'Nữ', '2010-08-20', '0912345120', 'lethithu200810@gmail.mock', N'Quận 3, TP.HCM', N'Gia đình cơ bản', N'Lê Văn Thắng', '0987654120', 'Active'),
-- Grade 11 (DOB: 2009)
(35, N'Phạm Công Vinh', N'Nam', '2009-01-10', '0912345121', 'phamcongvinh100109@gmail.mock', N'Quận 4, TP.HCM', N'Gia đình cơ bản', N'Phạm Thị Vân', '0987654121', 'Active'),
(36, N'Võ Ngọc Trâm', N'Nữ', '2009-02-15', '0912345122', 'vongoctram150209@gmail.mock', N'Quận 5, TP.HCM', N'Hộ nghèo', N'Võ Văn Triết', '0987654122', 'Active'),
(37, N'Đặng Quang Huy', N'Nam', '2009-03-22', '0912345123', 'dangquanghuy220309@gmail.mock', N'Quận 7, TP.HCM', N'Gia đình khá giả', N'Đặng Thị Hoa', '0987654123', 'Active'),
(38, N'Bùi Tuấn Anh', N'Nam', '2009-04-28', '0912345124', 'buituananh280409@gmail.mock', N'Quận 8, TP.HCM', N'Gia đình cơ bản', N'Bùi Văn Tú', '0987654124', 'Active'),
(39, N'Đỗ Thanh Thảo', N'Nữ', '2009-05-05', '0912345125', 'dothanhthao050509@gmail.mock', N'Quận 10, TP.HCM', N'Gia đình cơ bản', N'Đỗ Thị Tâm', '0987654125', 'Active'),
(40, N'Hồ Văn Bình', N'Nam', '2009-06-12', '0912345126', 'hovanbinh120609@gmail.mock', N'Quận 11, TP.HCM', N'Hộ nghèo', N'Hồ Thị Bích', '0987654126', 'Active'),
(41, N'Lý Tuyết Mai', N'Nữ', '2009-07-18', '0912345127', 'lytuyetmai180709@gmail.mock', N'Tân Bình, TP.HCM', N'Gia đình khá giả', N'Lý Văn Mười', '0987654127', 'Active'),
(42, N'Mai Xuân Kiên', N'Nam', '2009-08-25', '0912345128', 'maixuankien250809@gmail.mock', N'Gò Vấp, TP.HCM', N'Gia đình cơ bản', N'Mai Thị Kim', '0987654128', 'Active'),
(43, N'Ngô Thị Thủy', N'Nữ', '2009-09-01', '0912345129', 'ngothithuy010909@gmail.mock', N'Tân Phú, TP.HCM', N'Gia đình cơ bản', N'Ngô Văn Thái', '0987654129', 'Active'),
(44, N'Phan Việt Dũng', N'Nam', '2009-10-10', '0912345130', 'phanvietdung101009@gmail.mock', N'Phú Nhuận, TP.HCM', N'Gia đình khá giả', N'Phan Thị Diệp', '0987654130', 'Active'),
(45, N'Hoàng Kim Ngân', N'Nữ', '2009-11-15', '0912345131', 'hoangkimngan151109@gmail.mock', N'Bình Thạnh, TP.HCM', N'Gia đình cơ bản', N'Hoàng Văn Ngữ', '0987654131', 'Active'),
(46, N'Vũ Minh Khôi', N'Nam', '2009-12-20', '0912345132', 'vuminhkhoi201209@gmail.mock', N'Bình Tân, TP.HCM', N'Hộ nghèo', N'Vũ Thị Khuyên', '0987654132', 'Active'),
(47, N'Trịnh Gia Huy', N'Nam', '2009-01-05', '0912345133', 'trinhgiahuy050109@gmail.mock', N'Thủ Đức, TP.HCM', N'Gia đình cơ bản', N'Trịnh Văn Hoàng', '0987654133', 'Active'),
(48, N'Đào Thu Hương', N'Nữ', '2009-02-12', '0912345134', 'daothuhuong120209@gmail.mock', N'Nhà Bè, TP.HCM', N'Gia đình khá giả', N'Đào Thị Hạnh', '0987654134', 'Active'),
(49, N'Nguyễn Trọng Nhân', N'Nam', '2009-03-18', '0912345135', 'nguyentrongnhan180309@gmail.mock', N'Hóc Môn, TP.HCM', N'Gia đình cơ bản', N'Nguyễn Văn Nghĩa', '0987654135', 'Active'),
-- Grade 12 (DOB: 2008)
(50, N'Trần Thị Mộng', N'Nữ', '2008-01-10', '0912345136', 'tranthimong100108@gmail.mock', N'Bình Chánh, TP.HCM', N'Gia đình cơ bản', N'Trần Văn Mẫn', '0987654136', 'Active'),
(51, N'Lê Đình Phúc', N'Nam', '2008-02-15', '0912345137', 'ledinhphuc150208@gmail.mock', N'Quận 1, TP.HCM', N'Gia đình khá giả', N'Lê Thị Phương', '0987654137', 'Active'),
(52, N'Phạm Thành Đạt', N'Nam', '2008-03-22', '0912345138', 'phamthanhdat220308@gmail.mock', N'Quận 3, TP.HCM', N'Hộ nghèo', N'Phạm Văn Đồng', '0987654138', 'Active'),
(53, N'Võ Thanh Phong', N'Nam', '2008-04-28', '0912345139', 'vothanhphong280408@gmail.mock', N'Quận 4, TP.HCM', N'Gia đình cơ bản', N'Võ Thị Phụng', '0987654139', 'Active'),
(54, N'Đặng Thị Minh', N'Nữ', '2008-05-05', '0912345140', 'dangthiminh050508@gmail.mock', N'Quận 5, TP.HCM', N'Gia đình cơ bản', N'Đặng Văn Mạnh', '0987654140', 'Active');
